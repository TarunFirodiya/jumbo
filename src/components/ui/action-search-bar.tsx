        ...
        <div className="w-full sticky top-0 bg-background z-10">
          ...
          <div className="relative">
            <Input 
              ...
              className="pl-12 pr-4 py-3 h-14 text-base focus-visible:ring-offset-0 focus-visible:ring-2 focus-visible:ring-primary/50 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-[20px] shadow-sm" 
            />
